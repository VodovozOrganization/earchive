...
!define PRODUCT_NAME "QS: Электронный архив"
!define SHORTCUT_NAME "QS Электронный архив"
!define MENU_DIR_NAME "Электронный архив"
!define EXE_NAME "earchive"
...
;Descriptions
  ...
  LangString DESC_SecVisual ${LANG_Russian} "Для работы программы необходимы библиотеки Microsoft Visual C++ 2015"
